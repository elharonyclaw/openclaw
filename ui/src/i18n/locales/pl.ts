...
export const pl: TranslationMap = {
  ...
  configForm: {
    ...
    draftRejected: "Nie udało się zapisać tego ustawienia. Twój szkic wciąż tu jest.",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      providerNotReady:
        "{provider} nie udostępnił użytecznego modelu lokalnego. Sprawdź wynik konfiguracji i spróbuj ponownie.",
    },
    manual: {
    ...
    success: {
      ...
      body: "OpenClaw otrzymał prawdziwą odpowiedź od {modelRef}. Możesz teraz rozpocząć rozmowę.",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupDismiss: "Korzystaj nadal z aplikacji internetowej",
    },
  },
  mcpServers: {
    add: "Dodaj serwer",
