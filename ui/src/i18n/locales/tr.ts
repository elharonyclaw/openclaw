...
export const tr: TranslationMap = {
  ...
  updates: {
    ...
    outcomeUnknown:
      "Güncelleme isteği kabul edilmiş olabilir, ancak Gateway yeniden bağlantıdan sonra nihai bir sonuç bildirmedi. Yeniden denemeden önce `openclaw update status` komutunu çalıştırın.",
    failureReasons: {
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      providerNotReady:
        "{provider} kullanılabilir bir yerel model sunmadı. Kurulum sonucunu inceleyin, ardından yeniden deneyin.",
    },
    manual: {
    ...
    success: {
      ...
      latency: "{latencyMs} ms'de doğrulandı",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Bir aracı ilerleme kaydetmeyi bıraktığında yinelenen araç çağrılarını uyaran veya engelleyen kayan geçmiş korumalarını etkinleştirin.",
    },
    localModelLean: {
  ...
  modelProviders: {
    ...
    readiness: {
      title: "AI kurulumu",
      heading: "Doğrulanmış bir AI modeli bağlayın",
      signedInNoModels:
